...
<html>
    ...
    <body style="background: #e5e4e4">
        ...
        if(isset($_SESSION["profesor"])){
            $homes = "inicio_profesores.php";
        }elseif(isset($_SESSION["administrador"])){
            $homes = "inicio_administrador.php";
        }
        ?>
        <?php
            ...
            <nav>
                <div class="nav-wrapper fixed green darken-4">
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <a class="btn-floating btn-large waves-effect waves-light green darken-4 right" href="<?php echo $homes?>" style=" margin-top: 3px;"><i class="material-icons">home</i></a>
                    </ul>
                </div>
            </nav>
         </div>
