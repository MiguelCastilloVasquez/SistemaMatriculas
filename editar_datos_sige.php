...
<html>
    ...
    <body style="background: #e5e4e4">
        ...
        $ind = filter_input(INPUT_GET, 'ind');
        $lab = filter_input(INPUT_GET, 'lab');
        $lug = filter_input(INPUT_GET, 'lug');
        ...
        <div class="container" style="margin-top: 50px">
            ...
            <form class="col s12" action="update_datos_sige.php" method="post">   
                ...
                <div class="row">
                    <div class="col s9">
                        <p class="blue-grey-text">Indique el ultimo nivel educacional 
                ...
                <div class="row">
                    <div class="col s9">
                        <p class="blue-grey-text">¿Cual es la situacion laboral de la persona asociada al estudiante? Seleccione una Alternativa.
                        </p>
                ...
                <div class="row">
                    <div class="col s9">
                        <p class="blue-grey-text">Si actualmente la persona trabaja, ¿donde trabaja principalmente? Seleccione una Alternativa.
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col s4">
                        <select name="lugar_trabajo" required class="browser-default">
                            <option value="<?php echo $lug ?>"><?php echo $lug ?></option>
